    ...
    public function AjouteMenu()
    {
        ...
        switch ($choiceAjoute) {
            case 1:
                ...
                echo "Last name : ( kamal )\n";
                $LastName = trim(fgets(STDIN));
                echo "Email : (exemple@gmail.com) \n";
                $email = trim(fgets(STDIN));
                echo "Phone Number : (0600000000)\n";
                $phone = trim(fgets(STDIN));
                echo "Gender : (male / female)\n";
                $gender = trim(fgets(STDIN));
                echo "Date Of bithday : (2000-02-20)\n";
                $birdth = trim(fgets(STDIN));
                echo "Adress : (marrakech)\n";
